...
class Node:
    ...
    def draw_line(self, sc:pygame.Surface, other:'Node') -> None:
        '''
        vẽ đường thẳng từ node này đến node khác
        '''
        pygame.draw.line(sc, self.color, (self.x, self.y), (other.x, other.y), 2)
